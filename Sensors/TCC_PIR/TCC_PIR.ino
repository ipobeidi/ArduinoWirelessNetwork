...
void setup() {
  ...
  pinMode(pinopir, INPUT);       //pino sensor PIR  como entrada
...
void loop() {
  ...
  if(timer)
  {           
    payload_t payload ={endNo,sIntervalo,Modo,tipo,LerPir()}; //faz o pacote a ser transmitido
...
int LerPir()//faz leitura do sensor Pir
{
